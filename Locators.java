...
public class Locators {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//NOTICE ALL OUR LOCATORS USED>? ONE ON ONE MAPPING
		...
		//we use xpath because for css you cant add an array to check the index it wont work "input[type='text'][2]") wont work
		//to do index in css do like this input[type='text']:nth-child(2) most time this chooses 2 elements because of hidden atributes, that why xpath and css my defer
		...
		//so to get phone number //form/input, but issue here is that the form has multiple input and it got confused
